  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-game-admin-game-admin-game-module~pages-game-game-game-module~pages-game-result-result~2beb2a8f"], {
    ...
    function srcAppComponentsComponentsModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      ComponentsModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"].forRoot(), _angular_forms__WEBPACK_IMPORTED_MODULE_20__["FormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_11__["RouterModule"], ngx_ionic_image_viewer__WEBPACK_IMPORTED_MODULE_12__["NgxIonicImageViewerModule"]],
    ...
    function srcAppComponentsEventEventListEventListComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var EventListComponent = /*#__PURE__*/function () {
        //isAdmin = false;
        function EventListComponent(requestService, dialog, modalController, authUser) {
        ...
        _createClass(EventListComponent, [{
          ...
          value: function verificationAdmin() {
            ...
            if (this.authUser.isAdminTeam(this.team_l.id) || this.authUser.isAdminTeam(this.team_v.id)) {
              this.isAdmin = true;
              if (this.authUser.isAdminTeam(this.team_l.id)) this.team_admin = this.team_l;
              if (this.authUser.isAdminTeam(this.team_v.id)) this.team_admin = this.team_v;
      ...
      var PublicationComponent = /*#__PURE__*/function () {
        ...
        _createClass(PublicationComponent, [{
                  ...
                  switch (_context7.prev = _context7.next) {
                    ...
                    case 2:
                      ...
                      modal.onDidDismiss().then(function (data) {
                        ...
                        _this11.utilArray.listUpdate(_this11.user.publications, publication.id, publication);
                      });
                      _context7.next = 6;
                      return modal.present();
          ...
          value: function openMenuPublication(publication) {
            ...
            this.dialog.actionSheetEditDelete(function () {
              _this12.editPublication(publication);
            }, function () {
              _this12.dialog.presentAlertConfirm('Alerta', '¿Seguro de eliminar esta aplicación?', function () {
                _this12.publcationModel.api_delete(publication.id).subscribe(function (response) {
                  if (response['status'] = 'success') {
                    _this12.utilArray.listDelete(_this12.user.publications, publication.id);

                    _this12.dialog.showToast('Publicacion Eliminada', null, 'success');
                  }
                });
              });
            });
                    ...
                    case 2:
                      ...
                      modal.onDidDismiss().then(function (data) {
                        ...
                        if (data.data && data.data['publication']) {
                          ...
                          _this13.utilArray.listUpdate(_this13.user.publications, _publication.id, _publication);
                        }
                      });
                      _context8.next = 6;
                      return modal.present();
            ...
            if (this.object) {
              if (this.isFavorite()) {
                ...
                this.favoriteModel.api_function('addFavorite', parms).subscribe(function (response) {
                  if (response['status'] == 'success') {
                    _this14.object.favorite = response['data'];
                  }
                }, function (error) {
                  console.error(error);
                });
        ...
        _createClass(RedListComponent, [{
                  ...
                  switch (_context10.prev = _context10.next) {
                    ...
                    case 2:
                      ...
                      modal.onDidDismiss().then(function (data) {
                        ...
                        _this16.utilArray.listAddLast(_this16.list, red); //this.redModel.listAddLast(red);
                  ...
                  switch (_context11.prev = _context11.next) {
                    ...
                    case 2:
                      ...
                      modal.onDidDismiss().then(function (data) {
                        ...
                        _this17.utilArray.listUpdate(_this17.list, red.id, red);
                      });
                      _context11.next = 6;
                      return modal.present();
          ...
          value: function _delete(red) {
            ...
            this.redModel.api_delete(red.id).subscribe(function (data) {
              ...
              if (data['status'] == 'success') {
                _this19.dialog.showToast('Game Eliminado', null, 'success');

                _this19.utilArray.listDelete(_this19.list, red.id);
              }
            });
          }
        }, {
                  ...
                  switch (_context13.prev = _context13.next) {
                    case 0:
                      ...
                      return this.eventModel.api_function('dataEventCreate', {
                        ...
                        if (data['status'] == 'success') {
                          _this20.dataEvent = data['data'];
                          _this20.types_events = _this20.dataEvent['types_events'];
                        }

                        console.log('ty', _this20.types_events);
                        console.log(_this20.dataEvent);
                      });
          ...
          value: function submit() {
            ...
            if (this.event.id) {
              this.eventModel.api_update(this.event).subscribe(function (data) {
                ...
                if (data['status'] == 'success') {
                  _this21.dialogService.showToast((_a = data['msjSuccess']) !== null && _a !== void 0 ? _a : 'Registrado');

                  console.log(data);

                  _this21.dismiss(data['Event']);
                }
              });
            } else {
          ...
          value: function initObject() {
            ...
            if (this.id) {
              this.servicePublication.api_find(this.id).subscribe(function (data) {
                if (data['status'] == 'success') {
                  _this22.publication = data['Publication'];

                  if (_this22.publication.image) {
                    _this22.photoModel.setImage(_this22.publication.image);
                  }
                }
              });
            }
          ...
          value: function submit() {
            ...
            if (this.publication.id) {
              this.servicePublication.api_update(this.publication).subscribe(function (data) {
                ...
                if (data['status'] == 'success') {
                  _this23.dialogService.showToast((_a = data['msjSuccess']) !== null && _a !== void 0 ? _a : 'Registrado');

                  console.log(data);

                  _this23.dismiss(data['Publication']);
                }

                _this23.posting = false;
              }, function (error) {
                _this23.posting = false;
              });
            } else {
                  ...
                  switch (_context16.prev = _context16.next) {
                    ...
                    case 4:
                      this.publicationModel.api_functionModel(this.id, 'pageShow').subscribe(function (response) {
                        console.log(response);
                        _this25.publication = response['data'];
                        if ($event) $event.target.complete();

                        _this25.dialogService.dimissLoaging();
                      }, function (error) {
                        if (_this25.util.notFoundItemApi(error)) {
                          _this25.notFound = true;
                        } //this.notFound = true;
                  ...
                  switch (_context17.prev = _context17.next) {
                    ...
                    case 4:
                      this.redModel.api_find(this.id).subscribe(function (response) {
                        _this26.red = response['Red'];

                        _this26.dialogService.dimissLoaging();
                      });
          ...
          value: function saveRed() {
            ...
            if (this.red.id) {
              this.redModel.api_update(this.red).subscribe(function (data) {
                ...
                if (data['status'] == 'success') {
                  _this27.dialogService.showToast((_a = data['msjSuccess']) !== null && _a !== void 0 ? _a : 'Registrado');

                  _this27.dismiss(data['Red']);
                }
              });
            } else {
...
//# sourceMappingURL=default~pages-game-admin-game-admin-game-module~pages-game-game-game-module~pages-game-result-result~2beb2a8f-es5.js.map